...
#define TGColorLine RGB(0xd2d2d2)


#define KCBackGroundColor RGB(0xf5f5f5)
#define backGround [UIColor colorWithRed:245.0/255 green:245.0/255 blue:245.0/255 alpha:1.000]
#define TitleColor [UIColor colorWithRed:18.0/255 green:123.0/255 blue:192.0/255 alpha:1.000]

//快速字体
#define TGFontWithSize(size)  [UIFont systemFontOfSize:size]
...
//整体颜色
#define COLOR  [UIColor colorWithRed:18.0/255 green:123.0/255 blue:192.0/255 alpha:1.000]


#define ImageViewHeight 50
